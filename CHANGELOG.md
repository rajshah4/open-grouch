...
## [0.1.1](https://github.com/rajshah4/open-grouch/compare/open-grouch-raj-v0.1.0...open-grouch-raj-v0.1.1) (2026-03-13)


### ✨ Features

* `/condense` command to force compact conversation history ([#191](https://github.com/rajshah4/open-grouch/issues/191)) ([48f5782](https://github.com/rajshah4/open-grouch/commit/48f578245a7b46ee95ee37e61a1f666d7f3dffb4))
* **acp:** Send LLM-generated summary to tool call title ([#332](https://github.com/rajshah4/open-grouch/issues/332)) ([39919ec](https://github.com/rajshah4/open-grouch/commit/39919eca949538f6db158ae863a7bbf57cf6a289))
* Add --always-approve and --llm-approve CLI arguments for confirmation mode ([#110](https://github.com/rajshah4/open-grouch/issues/110)) ([d19029a](https://github.com/rajshah4/open-grouch/commit/d19029a7aac3459642a97b2a1d16222e103af033))
* Add --version/-v flag support to print CLI version ([#113](https://github.com/rajshah4/open-grouch/issues/113)) ([e7a45d2](https://github.com/rajshah4/open-grouch/commit/e7a45d2ed842b2ee7696d76a1a748d90db3dc660)), closes [#112](https://github.com/rajshah4/open-grouch/issues/112)
* Add dedicated plan window for agent task tracking ([#315](https://github.com/rajshah4/open-grouch/issues/315)) ([b28106a](https://github.com/rajshah4/open-grouch/commit/b28106a0f21dc0e80b2cfe3c5a9c9127ac0c17b2))
* Add details about recommended models and use cases in CLI settings ([#246](https://github.com/rajshah4/open-grouch/issues/246)) ([#357](https://github.com/rajshah4/open-grouch/issues/357)) ([b0f44ea](https://github.com/rajshah4/open-grouch/commit/b0f44ead2c7210b35271bd04c58bb5d1a64c3926))
* Add drag-to-select auto-copy feature for conversation events ([#312](https://github.com/rajshah4/open-grouch/issues/312)) ([29f7a8c](https://github.com/rajshah4/open-grouch/commit/29f7a8c48a589ea4089833c8ab9f5c92ded16247)), closes [#296](https://github.com/rajshah4/open-grouch/issues/296)
* add iterative refinement mode using critic model ([#447](https://github.com/rajshah4/open-grouch/issues/447)) ([bb54d4e](https://github.com/rajshah4/open-grouch/commit/bb54d4ef3d09bde8ea239f90968e219f4dd31aa5))
* add OpenHands stop hooks for pre-commit validation ([#487](https://github.com/rajshah4/open-grouch/issues/487)) ([328326c](https://github.com/rajshah4/open-grouch/commit/328326c0d018881920187534686fb85df60d6f8f))
* Add tabbed interface to settings modal ([#231](https://github.com/rajshah4/open-grouch/issues/231)) ([d98c5bf](https://github.com/rajshah4/open-grouch/commit/d98c5bf60ac20ac0beb3701f24f6b158b43e6b69))
* Add toggle for default cell expand/collapse state ([#295](https://github.com/rajshah4/open-grouch/issues/295)) ([98c5a44](https://github.com/rajshah4/open-grouch/commit/98c5a44023822bf06b1fdfe7df02022e865b7071))
* **cli:** add task & file params ([#131](https://github.com/rajshah4/open-grouch/issues/131)) ([1549d83](https://github.com/rajshah4/open-grouch/commit/1549d83a3d23465482983afece8d203c92534a98))
* **cli:** add threaded Ctrl-P pause listener for synchronous SDK ([#34](https://github.com/rajshah4/open-grouch/issues/34)) ([83ea030](https://github.com/rajshah4/open-grouch/commit/83ea0301f5a902002755effdabfbd3eaf7e7920d))
* Delegate conversation to cloud ([#230](https://github.com/rajshah4/open-grouch/issues/230)) ([307b5e4](https://github.com/rajshah4/open-grouch/commit/307b5e441af294c9beeab9f3d730f5c4406f087e))
* delegate tool for spawning sub-agents ([#341](https://github.com/rajshah4/open-grouch/issues/341)) ([a1987e4](https://github.com/rajshah4/open-grouch/commit/a1987e4c768d3c95e55dc7e635946d4fe821d818))
* **e2e:** add mock LLM server and full UI e2e tests ([#427](https://github.com/rajshah4/open-grouch/issues/427)) ([f3ff2fc](https://github.com/rajshah4/open-grouch/commit/f3ff2fc5333d31d55b766a9877eb883f415a2b0c))
* implement headless mode with auto-exit functionality ([#186](https://github.com/rajshah4/open-grouch/issues/186)) ([2c3cb91](https://github.com/rajshah4/open-grouch/commit/2c3cb91e8825d040cc220d81ec78ad899a7442e9))
* implement streaming LLM outputs for ACP implementation ([#254](https://github.com/rajshah4/open-grouch/issues/254)) ([e54611d](https://github.com/rajshah4/open-grouch/commit/e54611dce55d38269a2bdcba91345fb169b182d0))
* implement support for skills and legacy microagents in CLI ([#53](https://github.com/rajshah4/open-grouch/issues/53)) ([ca220e2](https://github.com/rajshah4/open-grouch/commit/ca220e2900e994e98b5c4b348759ac0f0698a80d))
* launch CLI as a browser app ([#247](https://github.com/rajshah4/open-grouch/issues/247)) ([6fb6bf6](https://github.com/rajshah4/open-grouch/commit/6fb6bf6292bd6f572cec523c153965c927a401e4))
* Load hooks from ~/.openhands/hooks.json in CLI ([#428](https://github.com/rajshah4/open-grouch/issues/428)) ([2d7842f](https://github.com/rajshah4/open-grouch/commit/2d7842fec141d0d452f9fa174818b957fd40a4d6))
* **mcp:** Add enable/disable functionality for MCP servers ([#242](https://github.com/rajshah4/open-grouch/issues/242)) ([947b29e](https://github.com/rajshah4/open-grouch/commit/947b29e307b8010f92241eeeb918e8910c567567))
* send metadata for models using llm-proxy base URLs ([#377](https://github.com/rajshah4/open-grouch/issues/377)) ([8aa2a49](https://github.com/rajshah4/open-grouch/commit/8aa2a491ce3b1364e3b16c594fc399bd9e17f8d1))
* Show context window and cost metrics in status bar ([#331](https://github.com/rajshah4/open-grouch/issues/331)) ([afa8d3d](https://github.com/rajshah4/open-grouch/commit/afa8d3d53046c0c82a3fe3cccceb33eb064147b4))
* show conversation list and ability to resume latest conversation ([#193](https://github.com/rajshah4/open-grouch/issues/193)) ([8c802ab](https://github.com/rajshah4/open-grouch/commit/8c802abfbd95da4e87f18ec5a3bb5b3b2f2d19d7))
* Show loaded resources (skills, hooks, MCPs) and add /skills command ([#474](https://github.com/rajshah4/open-grouch/issues/474)) ([29e6930](https://github.com/rajshah4/open-grouch/commit/29e6930b778801efe2c95456c9afa3df4c3d3431))
* support agent setup via environment variables ([#366](https://github.com/rajshah4/open-grouch/issues/366)) ([9f5bef3](https://github.com/rajshah4/open-grouch/commit/9f5bef3f6523907fec72f15db09b2244ebf6e616))
* support auth for local ACP agent ([#394](https://github.com/rajshah4/open-grouch/issues/394)) ([01fadb7](https://github.com/rajshah4/open-grouch/commit/01fadb70e9d694792de8a306d90f25cdee15e36d))
* truncate long commands in collapsed view with visual hierarchy ([d31f40c](https://github.com/rajshah4/open-grouch/commit/d31f40ce1c2914cd881e9820285ed455cf0e358d)), closes [#334](https://github.com/rajshah4/open-grouch/issues/334)
* **tui:** bind ctrl+a to select all text in input area ([#511](https://github.com/rajshah4/open-grouch/issues/511)) ([0b98f5d](https://github.com/rajshah4/open-grouch/commit/0b98f5d8b893681d57202e9b5e12a712c86d9153))
* **tui:** conversation history side panel ([#333](https://github.com/rajshah4/open-grouch/issues/333)) ([8a0df43](https://github.com/rajshah4/open-grouch/commit/8a0df4393b6293993a42df0cdc7fe584fdd12d71))


### 🐛 Bug Fixes

* **acp:** send session/update after session/new response ([#543](https://github.com/rajshah4/open-grouch/issues/543)) ([4031e70](https://github.com/rajshah4/open-grouch/commit/4031e70cd6aeb35d33a20897148b0a6c0f15888a))
* Check for openhands/ prefix instead of litellm_proxy ([#57](https://github.com/rajshah4/open-grouch/issues/57)) ([d2bd402](https://github.com/rajshah4/open-grouch/commit/d2bd40270153522d0a0d04df3ba6ceb1763c1b9d))
* **ci:** fix linting issues in grouch files and yaml formatting ([a4c42fa](https://github.com/rajshah4/open-grouch/commit/a4c42fa43f2393c1108fea645fd57f6451b69edd))
* **ci:** prevent docs, chore, style, refactor, test, ci commits from triggering releases ([57a32ec](https://github.com/rajshah4/open-grouch/commit/57a32ecb6a20a1bc7902fa3c7c7f796f65c42320))
* **ci:** prevent docs, chore, style, refactor, test, ci commits from triggering releases ([6389e3b](https://github.com/rajshah4/open-grouch/commit/6389e3b22c3b13b9b9e95faa2b5bd3499e2ad69e))
* **ci:** rename acp.py to acp_cli.py to avoid import conflict with acp package ([32007b9](https://github.com/rajshah4/open-grouch/commit/32007b97affc6b20b9693a77cd4b9d10db17ef0c))
* **ci:** update uv.lock for open-grouch package name and simplify release workflow ([32cd408](https://github.com/rajshah4/open-grouch/commit/32cd40860ce0a7dbdfcec545923926d1845e4ae6))
* **ci:** use OpenHands LLM proxy for PR reviews ([303fdf3](https://github.com/rajshah4/open-grouch/commit/303fdf3832187297cd31df27ab9a21e2c800dc44))
* **ci:** use ubuntu-24.04 for PR review workflow ([95d5c34](https://github.com/rajshah4/open-grouch/commit/95d5c34d659ea741a5f11b3e8c7065b126271125))
* Clear values of settings modal using .clear() instead of setting as blank ([#514](https://github.com/rajshah4/open-grouch/issues/514)) ([48c6dc5](https://github.com/rajshah4/open-grouch/commit/48c6dc5f6c2162a0a70a10042085b2f1b5443d46))
* **cli:** add terminal compatibility detection ([#205](https://github.com/rajshah4/open-grouch/issues/205)) ([c79c651](https://github.com/rajshah4/open-grouch/commit/c79c6512aeb527e614198cb228e69b3bf5a1b700))
* clipboard copy when copy button is pressed ([#273](https://github.com/rajshah4/open-grouch/issues/273)) ([0fe9e35](https://github.com/rajshah4/open-grouch/commit/0fe9e35251a7347a302e48c1665797e31d3d2cd2))
* Correctly format LLM model names for litellm providers ([#322](https://github.com/rajshah4/open-grouch/issues/322)) ([060769c](https://github.com/rajshah4/open-grouch/commit/060769cb89fae9888ce51dd352e696299b4f73dd))
* critic - no module named posthog ([#448](https://github.com/rajshah4/open-grouch/issues/448)) ([bc83841](https://github.com/rajshah4/open-grouch/commit/bc838417d25294858b53cb065b3c967932db2408))
* default collapsibles to collapsed state ([#504](https://github.com/rajshah4/open-grouch/issues/504)) ([a60470c](https://github.com/rajshah4/open-grouch/commit/a60470cb61eefdb5c5b55b4c04b5f6b7c2967aa6))
* display 'Open Grouch' in --version output instead of 'OpenHands CLI' ([faba2e9](https://github.com/rajshah4/open-grouch/commit/faba2e9b55b5abe8c3573752e7fa549f5700e5b0))
* display 'Open Grouch' in --version output instead of 'OpenHands CLI' ([3644346](https://github.com/rajshah4/open-grouch/commit/36443460af5484562b0b5872efe311f23aa57c26)), closes [#12](https://github.com/rajshah4/open-grouch/issues/12)
* display agent MessageEvents in TUI when critic is enabled ([#400](https://github.com/rajshah4/open-grouch/issues/400)) ([c1c5895](https://github.com/rajshah4/open-grouch/commit/c1c5895026046f196cfc0a4ddafa28a26ac074d4))
* **docs:** restore AGENTS.md and fix PR types section ([0e556ce](https://github.com/rajshah4/open-grouch/commit/0e556ce5155937054fa79ac8e5bc2dbdfa31fab5))
* hardcode base_url for OpenHands provider in CLI ([#168](https://github.com/rajshah4/open-grouch/issues/168)) ([508dd66](https://github.com/rajshah4/open-grouch/commit/508dd66cadd70c5cf47797e5b5e951c5ee34290d))
* **input:** implement auto-growing input with soft wrapping ([#276](https://github.com/rajshah4/open-grouch/issues/276)) ([618016e](https://github.com/rajshah4/open-grouch/commit/618016e25bc29227cad7675a8d0764e756043bf3))
* issue with memory condensation not being editable ([#372](https://github.com/rajshah4/open-grouch/issues/372)) ([149ff3e](https://github.com/rajshah4/open-grouch/commit/149ff3ee977cbc69a22b62307321e0e2bc8a1da9))
* **Makefile:** help and pre-commit ([#528](https://github.com/rajshah4/open-grouch/issues/528)) ([7443e0c](https://github.com/rajshah4/open-grouch/commit/7443e0c018885336382de3ad0e4392f312e9e319))
* mock splash header for deterministic snapshot tests ([ef2a023](https://github.com/rajshah4/open-grouch/commit/ef2a0234ddb5cd7d5449d385d2fdd523e252a96c))
* pass Laminar API key as action input in PR review workflow ([#484](https://github.com/rajshah4/open-grouch/issues/484)) ([e30f02d](https://github.com/rajshah4/open-grouch/commit/e30f02db5b206b0e5e79150fdad9904a7dcd8511))
* patch random.choice for deterministic snapshot tests ([afdca01](https://github.com/rajshah4/open-grouch/commit/afdca0174b2445252c2976ff0d22253de5cfd061))
* pin rich&lt;14.3.0 to fix autocomplete shutdown crash ([#402](https://github.com/rajshah4/open-grouch/issues/402)) ([9896d02](https://github.com/rajshah4/open-grouch/commit/9896d02174071f8e78e51b4cd3adb4eefed6f9be))
* require --override-with-envs flag to apply LLM env vars ([#379](https://github.com/rajshah4/open-grouch/issues/379)) ([3bed5c7](https://github.com/rajshah4/open-grouch/commit/3bed5c72322fcf637cc815574351e4a79edc7667))
* resolve line length violations in personality.py ([f1ea6ce](https://github.com/rajshah4/open-grouch/commit/f1ea6ce34d3a265672c3834957940edb543e0b84))
* seed random for deterministic snapshot tests ([156fbd6](https://github.com/rajshah4/open-grouch/commit/156fbd68d9811cf1f3011fb66967ceb708a1a4ec))
* Set prompt_continuation to empty string for cleaner multiline input ([#65](https://github.com/rajshah4/open-grouch/issues/65)) ([d1a65de](https://github.com/rajshah4/open-grouch/commit/d1a65de7bd67a60a1040c24a66a1adf8e401a53a))
* shorten comment line to stay within 88 character limit ([349fb3a](https://github.com/rajshah4/open-grouch/commit/349fb3ac8a1a76fba93a9bd11a71e7b5eb310e87))
* Skip PR description update if uvx section already exists ([#279](https://github.com/rajshah4/open-grouch/issues/279)) ([764d5d8](https://github.com/rajshah4/open-grouch/commit/764d5d82f666ea0384559a52c1657042c94382a4))
* **test:** patch pytest-textual-snapshot for deterministic color normalization ([6c2d586](https://github.com/rajshah4/open-grouch/commit/6c2d58606eef1627082390de2ae1261c2df2631a))
* **tests:** disable input cursor blink for snapshots ([#0](https://github.com/rajshah4/open-grouch/issues/0)) ([#476](https://github.com/rajshah4/open-grouch/issues/476)) ([08b5c2e](https://github.com/rajshah4/open-grouch/commit/08b5c2ef5a9ec3761421ff5b36dbfcd88b171d3c))
* **tests:** fix broken tests and update snapshots ([b24fa7e](https://github.com/rajshah4/open-grouch/commit/b24fa7e1c239653b95af881c2b5cfec0112bddee))
* **tests:** make creating_agent_plan snapshot test deterministic ([#524](https://github.com/rajshah4/open-grouch/issues/524)) ([4059e04](https://github.com/rajshah4/open-grouch/commit/4059e0488e4bfab45c8742f21a7aace134f743d1))
* **tui:** add ComposeResult return type hints to compose() methods ([#509](https://github.com/rajshah4/open-grouch/issues/509)) ([5e03331](https://github.com/rajshah4/open-grouch/commit/5e03331794a2cab3cd843233cf17fd95d41fea76))
* **tui:** disable markup parsing for user messages to prevent crashes ([#286](https://github.com/rajshah4/open-grouch/issues/286)) ([ad479be](https://github.com/rajshah4/open-grouch/commit/ad479be5e8e7f365fb4ba7a55baed69b8bae7a7f))
* **tui:** reset token metrics when creating new conversation ([#439](https://github.com/rajshah4/open-grouch/issues/439)) ([811604f](https://github.com/rajshah4/open-grouch/commit/811604f78175c920d9efb3dd610ffdbcb3ad2319))
* **types:** add missing type hints to handle_resume_logic and _meta ([#532](https://github.com/rajshah4/open-grouch/issues/532)) ([5f1510b](https://github.com/rajshah4/open-grouch/commit/5f1510bf874aa738ad5735d2245d60e3346ba2c4))
* update splash screen to display Open Grouch branding and version ([599d08b](https://github.com/rajshah4/open-grouch/commit/599d08bc4f886bc6d4a641bd4cdee836ad5796c9))
* update splash screen to display Open Grouch branding and version ([8d3cf0e](https://github.com/rajshah4/open-grouch/commit/8d3cf0e7cfa3fc1996a98214dbdf450ebcaca5fe))
* use ~/.open-grouch for config directory instead of ~/.openhands ([e93380e](https://github.com/rajshah4/open-grouch/commit/e93380e4c15636003ef3c005298f383df6224cd9))
* use ~/.open-grouch for config directory instead of ~/.openhands ([34204c9](https://github.com/rajshah4/open-grouch/commit/34204c9719218b50d42555b5e68f3ff3c8f7002b))
* use model_id without provider prefix when loading settings ([#280](https://github.com/rajshah4/open-grouch/issues/280)) ([d2c4a03](https://github.com/rajshah4/open-grouch/commit/d2c4a0397374b1bc48da8c11aa70721ae4d4330c))
* **widgets:** remove unnecessary type: ignore in collapsible.py ([#458](https://github.com/rajshah4/open-grouch/issues/458)) ([7e56e1a](https://github.com/rajshah4/open-grouch/commit/7e56e1a1fd8f2164b523bd2ea3788621d24f3c25))


### 🗑️ Grouch Personality

* add Oscar the Grouch personality to agent ([f17f1e1](https://github.com/rajshah4/open-grouch/commit/f17f1e1c18ae2a91baccafbffb334633260675f1))
* disable critic by default ([7674665](https://github.com/rajshah4/open-grouch/commit/7674665052329ac0b173799f6b8c76044ccaeeb9)), closes [#10](https://github.com/rajshah4/open-grouch/issues/10)
